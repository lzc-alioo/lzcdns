            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="info-box magenta-bg">
                        ...
                        <div class="count" id="hitCachedCount">-</div>
                        <div class="title">缓存查询次数/命中缓存次数</div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function loadSummary()
    {
        $.post('./summary', {}, function(result)
        {
            ...
            $('#totalQueryCount').html(result.data.totalQueryCount+"/"+result.data.totalAnswerCount);
            $('#totalQueryUpstreamCount').html(result.data.totalQueryUpstreamCount);
            $('#totalCachedCount').html(result.data.totalCachedCount);
            $('#hitCachedCount').html(result.data.queryCachedCount+"/"+result.data.hitCachedCount);
