...
import com.lzc.dns.util.Nonce;
import com.lzc.dns.util.pool.IdGenerator;
...
import com.lzc.dns.web.service.UserService;
...
//            session.setAttribute("loginUser", user);
            ...
            result.setData(Result.values("token", token));
        } catch (Exception ex) {
            result.setError(ex);
        }
        return result;
